...
describe('unified dashboard workspace', () => {
  it('uses one overview request and one linked analytics workspace', () => {
    ...
    assert.equal(animation.includes('pageDuration: 1.2'), true);
    assert.equal(animation.includes('cardDuration: 1.4'), true);
    assert.equal(animation.includes('chartDuration: 2.8'), true);
    assert.equal(animation.includes('compactChartDuration: 1.8'), true);
    assert.equal(animation.includes('progressDuration: 1.8'), true);
    assert.equal(animation.includes('counterDurationMs: 2200'), true);
    assert.equal(animation.includes('counterFrameMs: 16'), true);
    ...
    assert.equal(animation.includes('maxElementDelay: 0.6'), true);
