...
const demoProducts: Product[] = [
  {
    ...
    isFeatured: true,
    variants: [
      { id: '900g', label: '900g', stockQuantity: 12, price: 119.9 },
      { id: '1-8kg', label: '1,8kg', stockQuantity: 6, price: 219.9 },
    ],
  },
  {
    id: 'creatina',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1579722821273-0f6c7d44362f?auto=format&fit=crop&w=900&q=80',
    stockQuantity: 41,
    isActive: true,
    variants: [
      { id: '150g', label: '150g', stockQuantity: 19, price: 59.9 },
      { id: '300g', label: '300g', stockQuantity: 22, price: 89.9 },
    ],
  },
  {
    id: 'pre-treino',
    ...
    price: 109.9,
    category: 'Energia',
    imageUrl: 'https://images.unsplash.com/photo-1605296867424-35fc25c9212a?auto=format&fit=crop&w=900&q=80',
    stockQuantity: 9,
    isActive: true,
    variants: [{ id: '300g', label: '300g', stockQuantity: 9, price: 109.9 }],
  },
];
...
const initialOrders: Order[] = [
  {
    ...
    items: [
      { name: 'Whey Protein Chocolate', quantity: 1, variant: '900g', unitPrice: 119.9 },
      { name: 'Creatina Monohidratada', quantity: 1, variant: '300g', unitPrice: 89.9 },
    ],
  },
];
...
export default function App() {
  ...
  const colors: Colors = {
    ...
    primary: activeStore?.primaryColor || '#15b86a',
    danger: '#e5484d',
  };
