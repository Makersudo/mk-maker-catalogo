...
async function loadMobileStore(slugInput: string) {
  ...
  return {
    store: {
      ...
      primaryColor: settings.store_primary_color || '#c98f86',
      banner: settings.store_banner || 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&w=1200&q=80',
